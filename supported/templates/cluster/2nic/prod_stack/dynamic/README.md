...
```bash
openstack stack create stack-cluster-2nic-test -t src/f5-openstack-hot/supported/templates/cluster/2nic/prod_stack/dynamic/f5_bigip_cluster_n_nic.yaml -e src/f5-openstack-hot/supported/templates/cluster/2nic/prod_stack/dynamic/f5_bigip_cluster_n_nic_env.yaml
```
