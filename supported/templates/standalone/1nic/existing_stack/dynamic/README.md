...
```bash
openstack stack create stack-1nic-test -t src/f5-openstack-hot/supported/templates/standalone/1nic/existing_stack/dynamic/f5_bigip_standalone_1_nic.yaml -e src/f5-openstack-hot/supported/templates/standalone/1nic/existing_stack/dynamic/f5_bigip_standalone_1_nic_env.yaml
```
