...
```bash
openstack stack create stack-nnic-test -t src/f5-openstack-hot/experimental/templates/cluster/nnic/prod_stack/static/f5_bigip_cluster_n_nic.yaml -e src/f5-openstack-hot/experimental/templates/cluster/nnic/prod_stack/static/f5_bigip_cluster_n_nic_env.yaml
```
