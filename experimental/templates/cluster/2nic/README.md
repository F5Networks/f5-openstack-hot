...
| Parameter | Required | Description | Constraints |
| --- | --- | --- | --- |
| bigip_device_group | No | Name of the BIG-IP Device Group to create or join. Default 'Sync'  |  |
| bigip_auto_sync | No | Toggles flag for enabling BIG-IP Cluster Auto Sync. Default true  |  |
| bigip_save_on_auto_sync | No | Toggles flag for enabling saving on config-sync auto-sync . Default true  |  |
